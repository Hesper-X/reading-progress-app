        ...
        children: [
          Expanded(
            child: OutlinedButton.icon(
              ...
              label: const Text('想读书籍', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600)),
            ),
          ),
          ...
          Expanded(
            child: ElevatedButton.icon(
              ...
              icon: const Icon(Icons.add, size: 16),
              label: const Text('在读书籍', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600)),
            ),
          ),
        ],
      ),
